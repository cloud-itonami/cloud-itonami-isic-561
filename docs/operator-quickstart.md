# Operator Quickstart — cloud-itonami-isic-561

Shortest path from clone to a verified local dry-run for **ISIC 561** (`cloud-itonami-isic-561`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-561.git
cd cloud-itonami-isic-561
```
...
- Likely source path: `restaurantops.governor.cljc`
